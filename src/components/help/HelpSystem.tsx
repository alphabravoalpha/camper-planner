...
const helpArticles: HelpArticle[] = [
  // Getting Started
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Welcome to the European Camper Trip Planner! This tool helps you plan amazing camper van
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Creating your first route is easy! Follow these steps to plan your European adventure.
        </p>
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-primary-500 pl-4">
            ...
            <p className="text-neutral-700">
              Click anywhere on the map or use the search bar to add your first waypoint. This will
              be marked as your starting location.
            </p>
          </div>
          ...
          <div className="border-l-4 border-green-500 pl-4">
            ...
            <p className="text-neutral-700">
              Continue clicking on the map to add more waypoints. Each new point becomes part of
              your route. You can add as many stops as you want!
            </p>
          </div>
          ...
          <div className="border-l-4 border-yellow-500 pl-4">
            ...
            <p className="text-neutral-700">
              Drag waypoints in the sidebar to reorder your route. The app will automatically
          ...
          <div className="border-l-4 border-purple-500 pl-4">
            ...
            <p className="text-neutral-700">
              Use the route optimizer to find the most efficient order for your waypoints, saving
              time and fuel.
            </p>
          </div>
        </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-green-800 text-sm">
            Right-click on any waypoint for additional options like editing details, adding notes,
            or removing the waypoint.
          </p>
        </div>
      </div>
    ),
  ...
  // Route Planning
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-neutral-700">
          The route optimizer uses advanced algorithms to find the most efficient order for your
          waypoints.
        </p>
        ...
        <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-primary-800 text-sm">
            <li>
              <strong>Shortest Distance:</strong> Minimizes total kilometers
            </li>
            <li>
              <strong>Fastest Time:</strong> Minimizes total travel time
            </li>
            <li>
              <strong>Balanced:</strong> Optimizes for both distance and time
            </li>
            <li>
              <strong>Scenic Route:</strong> Prioritizes beautiful countryside roads
            </li>
          </ul>
        </div>
        ...
        <p className="text-neutral-700">
          Compare different route options to choose the best one for your needs.
        </p>

        <h4 className="font-semibold text-neutral-900">Elevation Profile</h4>
        <p className="text-neutral-700">
          View the elevation changes along your route to prepare for mountain passes and steep
          climbs.
        </p>

        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h5 className="font-medium text-yellow-900 mb-2 flex items-center gap-1">
            <AlertTriangle className="w-4 h-4" /> Important for Campers
          </h5>
          <p className="text-yellow-800 text-sm">
            Always check vehicle restrictions and road conditions, especially in mountainous areas.
            Some roads may not be suitable for large motorhomes.
          </p>
        </div>
      </div>
    ),
  ...
  // Vehicle Setup
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Setting up your vehicle profile ensures you get routes suitable for your camper van or
          motorhome.
        </p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-green-800 text-sm">
            You can save multiple vehicle profiles if you have different campers or plan to rent
            different vehicles for different trips.
          </p>
        </div>
      </div>
    ),
  ...
  // Sharing & Export
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Export your planned routes to GPS devices and navigation apps for offline use during your
          trip.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-primary-50 rounded-lg p-4">
            ...
            <p className="text-sm text-primary-800">
              Compatible with most GPS devices including Garmin, TomTom, and smartphone apps.
            </p>
          </div>
          <div className="bg-green-50 rounded-lg p-4">
            <h5 className="font-medium text-green-900 mb-2">KML Files</h5>
            <p className="text-sm text-green-800">
              Perfect for Google Earth and Google Maps. Great for sharing with others.
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div className="border border-red-200 rounded-lg p-4">
            ...
            <div className="text-sm text-red-800 space-y-1">
              <p>
                <strong>Possible causes:</strong> Network issues, browser settings, ad blockers
              </p>
              <p>
          ...
          <div className="border border-yellow-200 rounded-lg p-4">
            <h5 className="font-medium text-yellow-900 mb-2 flex items-center gap-1">
              <AlertTriangle className="w-4 h-4" /> Route Calculation Fails
            </h5>
            <div className="text-sm text-yellow-800 space-y-1">
              <p>
                <strong>Possible causes:</strong> Invalid waypoints, server issues, too many
                waypoints
              </p>
              <p>
                <strong>Solutions:</strong>
          ...
          <div className="border border-primary-200 rounded-lg p-4">
            <h5 className="font-medium text-primary-900 mb-2 flex items-center gap-1">
              <Info className="w-4 h-4" /> Saved Trip Disappeared
            </h5>
            <div className="text-sm text-primary-800 space-y-1">
              <p>
                <strong>Possible causes:</strong> Browser data cleared, different device/browser
              </p>
              <p>
                <strong>Solutions:</strong>
              </p>
        ...
        <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4">
          ...
          <p className="text-sm text-neutral-700">
            If these solutions don&apos;t help, please{' '}
            <a href="/feedback" className="text-primary-600 underline hover:text-primary-700">
              use the feedback form
            </a>{' '}
            to report the issue. Include details about your browser, device, and what you were
            trying to do.
          </p>
        </div>
      </div>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="space-y-6">
          <div>
            <h4 className="font-semibold text-neutral-900 mb-2 flex items-center gap-1">
              <Rocket className="w-4 h-4" /> Efficiency Tips
            </h4>
            <ul className="space-y-2 text-neutral-700">
              <li>
                <strong>Use keyboard shortcuts:</strong> Ctrl+Z to undo, Ctrl+Y to redo waypoint
                changes
              </li>
              <li>
                <strong>Bulk operations:</strong> Select multiple waypoints by holding Ctrl while
                clicking
              </li>
              <li>
                <strong>Quick add:</strong> Double-click the map to quickly add waypoints
              </li>
              <li>
                <strong>Smart search:</strong> Use specific addresses or coordinates for precise
                placement
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-neutral-900 mb-2 flex items-center gap-1">
              <Map className="w-4 h-4" /> Route Planning Tips
            </h4>
            <ul className="space-y-2 text-neutral-700">
              <li>
                <strong>Seasonal planning:</strong> Consider seasonal road closures in mountainous
                areas
              </li>
              <li>
                <strong>Fuel strategy:</strong> Plan fuel stops in areas with lower prices
              </li>
              <li>
                <strong>Border crossings:</strong> Account for potential delays at country borders
              </li>
              <li>
                <strong>Alternative routes:</strong> Always have a backup plan for main routes
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-neutral-900 mb-2 flex items-center gap-1">
              <Tent className="w-4 h-4" /> Camping Tips
            </h4>
            <ul className="space-y-2 text-neutral-700">
              <li>
                <strong>Book ahead:</strong> Popular campsites fill up quickly in summer
              </li>
              <li>
                <strong>Wild camping:</strong> Research local laws - it varies by country
              </li>
              <li>
                <strong>Facilities:</strong> Note which campsites have dump stations and fresh water
              </li>
              <li>
                <strong>Reviews:</strong> Check online reviews for real user experiences
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-neutral-900 mb-2 flex items-center gap-1">
              <Save className="w-4 h-4" /> Data Management
            </h4>
            <ul className="space-y-2 text-neutral-700">
              <li>
                <strong>Regular exports:</strong> Export your trips regularly as backup
              </li>
              <li>
                <strong>Multiple formats:</strong> Export in both GPX and JSON for maximum
                compatibility
              </li>
              <li>
                <strong>Cloud backup:</strong> Store exported files in cloud storage for access
                anywhere
              </li>
              <li>
                <strong>Version control:</strong> Keep different versions of your trip as it evolves
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <h5 className="font-medium text-purple-900 mb-2 flex items-center gap-1">
            <Target className="w-4 h-4" /> Master User Tip
          </h5>
...
const ArticleView: React.FC<{
  ...
  return (
    <div className="max-w-none">
      ...
      {/* Article Content */}
      <div className="prose prose-primary max-w-none">{article.content}</div>
...
const HelpSystem: React.FC<HelpSystemProps> = ({ className, defaultCategory, onClose }) => {
        ...
        <div className="flex-1 p-6">
          {searchQuery && (
            <div className="mb-4 text-sm text-neutral-600">
              Found {filteredArticles.length} article{filteredArticles.length !== 1 ? 's' : ''} for
              &quot;{searchQuery}&quot;
            </div>
          )}
                ...
                >
                  ...
                  <div className="flex items-center space-x-3 text-xs text-neutral-600">
                    <span className="flex items-center gap-1">
                      {category?.icon && <category.icon className="w-4 h-4" />} {category?.name}
                    </span>
                    <span
                      className={cn(
