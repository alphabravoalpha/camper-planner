    ...
    <div className="min-h-screen bg-neutral-50 animate-fade-in">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {SUPPORT_REASONS.map((reason) => {
              ...
              return (
                ...
                >
                  <div className="w-11 h-11 bg-accent-50 rounded-xl flex items-center justify-center mb-4">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 sm:p-8">
          <h2 className="text-xl font-bold text-neutral-900 mb-4">Other ways to help</h2>
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 text-sm">Star us on GitHub</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 text-sm">Spread the word</h3>
                <p className="text-neutral-500 text-sm mt-0.5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 text-sm">Report bugs and suggest features</h3>
                <p className="text-neutral-500 text-sm mt-0.5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 text-sm">Book through our links</h3>
                <p className="text-neutral-500 text-sm mt-0.5">
        ...
        {/* Thank You */}
        <div className="text-center bg-gradient-to-br from-accent-50 to-accent-100 rounded-2xl p-8">
          <Heart className="w-10 h-10 text-accent-500 mx-auto mb-3" />
          <h2 className="text-2xl font-bold text-accent-900 mb-2">Thank you</h2>
          ...
          <div className="mt-6">
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-accent-600 text-white rounded-xl font-semibold hover:bg-accent-700 transition-all duration-200 shadow-sm hover:shadow-medium active:scale-[0.97]"
            >
