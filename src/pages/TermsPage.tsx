        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 sm:p-8 space-y-8">
          ...
          <section>
            <p className="text-neutral-700 leading-relaxed">
              By using European Camper Trip Planner (&quot;the app&quot;), you agree to these terms. The
              app is provided free of charge as an open-source project.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="text-neutral-600 text-sm space-y-1 list-disc list-inside ml-2">
              ...
              <li>Vehicle restriction data (bridge heights, weight limits) may be incomplete or outdated</li>
          ...
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed">
              ...
              cost to you. Clicking these links takes you to external websites governed by their own
              terms and privacy policies. We are not responsible for the content, availability, or
              practices of these third-party sites. See our{' '}
          ...
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed">
              ...
              this page indicates when the terms were last modified.
            </p>
          </section>
